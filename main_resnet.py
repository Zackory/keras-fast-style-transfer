...
parser.add_argument('--style-weight', type=float, default=100000.0, help='Style weight')
# Default weights
# parser.add_argument('--content-weight', type=float, default=15.0, help='Content weight')
...
# x = Add()([x, Conv2D(64, 3, strides=(1, 1), padding='same', activation='linear')(Conv2D(64, 3, strides=(1, 1), padding='same', activation='relu')(x))])
...
content_pre = preprocess_input(content_input)
